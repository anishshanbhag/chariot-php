...
<title>Chariot || Blog Details</title>
						...
						<div id="recent-posts-4" class="popular-posts widget widget__sidebar wow bounceInUp animated animated" style="visibility: visible;">
							...
							<div class="widget-content">
							  <ul class="posts-list unstyled clearfix">
								<li>
									<figure class="featured-thumb"> <a href="#"> <img src="images/blog/1.png" class="img-thumbnail" alt="blog image"> </a> </figure>
									<!--featured-thumb-->
									<div class="content-info">
										<h4><a href="#" title="Lorem ipsum dolor sit amet">Launching shortly Chariot Gold</a></h4>
										<p class="post-meta">
										  <time class="entry-date">Jan 10, 2021 .</time>
										</p>
									</div>
								</li>
								<li>
									<figure class="featured-thumb"> <a href="#"> <img src="images/blog/2.png" class="img-thumbnail" alt="blog image"> </a> </figure>
									<!--featured-thumb-->
									<div class="content-info">
										<h4><a href="#" title="Lorem ipsum dolor sit amet">Launching shortly Chariot Gold</a></h4>
										<p class="post-meta">
											<time class="entry-date">Feb 26, 2021 .</time>
										</p>
									</div>
								</li>
								<li>
									<figure class="featured-thumb"> <a href="#"> <img src="images/blog/3.png" class="img-thumbnail" alt="blog image"> </a> </figure>
									<!--featured-thumb-->
									<div class="content-info">
										<h4><a href="#" title="Lorem ipsum dolor sit amet">Launching shortly Chariot Gold</a></h4>
										<p class="post-meta">
											<time class="entry-date">Mar 14, 2021 .</time>
										.</p>
									</div>
								</li>
							  </ul>
						...
						<div id="primary" class="site-content">
							<div id="content" role="main">
								<article id="post-29" class="blog_entry clearfix">
									<div>
										<div class="featured-thumb"><img src="images/blog/1.png" class="img-thumbnail" alt="blog-img4"></div>
										<header class="blog_entry-header clearfix">
											<div class="blog_entry-header-inner">
												<h1 class="blog_entry-title">Launching shortly Chariot Gold</h1>
										...
										<div class="entry-content">
											...
											<p style="text-align:justify;">Right now, grocery stores are still finding that traditional advertising is best for acquisition and retention.</p>
											<p style="text-align:justify;">First, grocery stores still see high value in print, radio and TV. This makes sense. For decades these channels have been the main way for grocery stores to reach their audience. There is still a high preference for these channels amongst grocery store customers. People over 50 years old and even those over 40 years old still use traditional media more than online media.</p>
										</div>					
									</div>
								</article>
									...
									<div class="comments-wrapper">
									  <h3> Comments </h3>
										<ol class="commentlist">
											<li class="comment">
												<div>
													<img alt="" src="images/client.png" class="avatar avatar-60 photo">
													<div class="comment-text">
														...
														<p class="meta">
															<strong>Anitha S</strong> 
															<span>–</span> <time>April 19, 2021</time>
														</p>
														<div class="description">
															<p>Oh my goodness... You know, this place has very good groceries at reasonable price for all items like Whole Wheat Chakki Atta, Maida, Suji Rava,Chiroti Rava,Dry Fruits And Nuts and so on. I have saved a lot both time and money by shopping through Grocery.</p>
														</div>
													</div>
												</div>
											</li><!-- #comment-## -->
